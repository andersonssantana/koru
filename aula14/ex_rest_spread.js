...
const backendSkills = ['Node.js', 'Databases', 'APIs'];

const fullstackSkills = [...frontendSkills, ...backendSkills];

console.log(fullstackSkills); // ['HTML', 'CSS', 'JavaScript', 'Node.js', 'Databases', 'APIs']
...
console.log(personWithAddress); // { name: 'Ana', age: 25, city: 'Recife', country: 'Brazil' }
